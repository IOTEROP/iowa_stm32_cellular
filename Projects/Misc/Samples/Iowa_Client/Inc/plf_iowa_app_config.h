...
#define USE_CUSTOM_APN							(0)		/* APN customization needed */
  ...
  /* IOWA_FULL_VERSION is a configuration option - if it is set then the sample code 
  * will use all Iowa(c) features
  */
#ifndef IOWA_FULL_VERSION  
#define USE_FULL_IOWA_VERSION					(0)   /* 0: not activated, 1: activated */
#else  
#define USE_FULL_IOWA_VERSION					(1)   /* 0: not activated, 1: activated */
#endif  
